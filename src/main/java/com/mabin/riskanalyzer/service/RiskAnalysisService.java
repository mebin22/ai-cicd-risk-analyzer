...
public class RiskAnalysisService {
    ...
    public RiskAnalysisService(
            RiskAnalysisRepository repository,
    ...
    public RiskResponseDTO analyzeRisk(RiskRequestDTO request) {
        ...
        if (logs.contains("unit test")
                || logs.contains("test failed")
                || logs.contains("assertion failed")) {
        ...
        } else if (logs.contains("dependency")
                || logs.contains("version conflict")) {
        ...
        } else if (logs.contains("memory")
                || logs.contains("timeout")
                || logs.contains("service unavailable")) {
        ...
        } else if (logs.contains("success")
                || logs.contains("passed")) {
